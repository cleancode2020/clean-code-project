		...
		<section className="privacy__main">
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to cleancode.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to cleancode, accessible from{" "}
							<a
								href="https://clean-code-project.web.app/"
								target="blank"
			...
			<div className="privacy__text">
				<p>
					...
					parts of our Service. Cookies can be &quot;Persistent&quot; or
